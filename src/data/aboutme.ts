...
export const aboutMe: AboutMe = {
  ...
  description:
    ...
    <p>Prior to my PhD, I graduated from the University of Tübingen and Saarland University, with a MSc and BSc in Computer Science. In my free time, I like drawing, recently getting into digital art through designing journal covers, and playing almost all racquet sports, especially tennis.</p>`,
